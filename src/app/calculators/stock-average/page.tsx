        ...
        <main className="min-h-screen bg-slate-50 py-8 px-4 md:px-8">
            <div className="max-w-5xl mx-auto">
                ...
                <nav className="flex items-center gap-2 text-sm text-slate-500 mb-8 overflow-x-auto whitespace-nowrap pb-2">
                    ...
                    <span className="font-medium text-slate-900">Stock Average Calculator</span>
                </nav>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="prose prose-slate text-slate-600">
                            ...
                            <ul className="list-disc pl-5 title-list space-y-2 mt-4">
                                ...
                                <li>
                                    <strong>Target Averaging:</strong> If you are stuck at a high price (e.g., ₹1000) and want to bring your average down to ₹900, this tool tells you exactly how many more shares to buy at the current market price (CMP).
                                </li>
                            </ul>
                        </div>
                    </div>
